...
void Gameplay::handleInput(void)
{
    ...
    if (this->_rayWindow.isKeyReleased(KEY_N))
        this->_characters[0].setPos(this->_characters[0].getPosition().x, this->_characters[0].getPosition().z + 2, RIGHT_DIR);
    if (this->_rayWindow.isKeyReleased(KEY_G))
        this->_characters[0].setPos(this->_characters[0].getPosition().x + 2, this->_characters[0].getPosition().z, TOP_DIR);
    if (this->_rayWindow.isKeyReleased(KEY_B))
        this->_characters[0].setPos(this->_characters[0].getPosition().x - 2, this->_characters[0].getPosition().z, DOWN_DIR);
    if (this->_rayWindow.isKeyReleased(KEY_V))
        this->_characters[0].setPos(this->_characters[0].getPosition().x, this->_characters[0].getPosition().z - 2, LEFT_DIR);
